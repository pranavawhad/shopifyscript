...
// function startTrackingPageData() {
//   // Event listener for DOMContentLoaded to track page visits
...
//     var lastVisitedPage = visitedPages.length > 0 ? visitedPages[visitedPages.length - 1] : null;
//     var isRevisitingPage = currentPage === lastVisitedPage;
...
//   // Event listener for unload to send data to the backend
//   window.addEventListener('unload', function() {
//     var currentTabURL = window.location.href;
//     var isTabClosed = !event.currentTarget.performance.navigation.type;

//     if (isTabClosed) {
//       var visitedPages = JSON.parse(sessionStorage.getItem('visitedPages'));

//       var apiEndpoint = 'https://04e7-2405-201-24-7912-346f-442f-761c-2218.ngrok-free.app/pages/';
//       var dataToSend = { first_page: visitedPages[0], other_pages: visitedPages.slice(1), shopName: shopName };
...
//       })
//       .catch(error => {
//         console.log('Error sending data to Django backend:', error);
//       });
//     }
//   });
// }

// // Call the function to start tracking page data
// startTrackingPageData();
